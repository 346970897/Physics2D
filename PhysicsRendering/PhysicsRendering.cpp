...
PhysicsBody* PhysicsRendering::create_circle_body(const double radius, const PhysicsTransform pose)
{
...
PhysicsBody* PhysicsRendering::create_ground_body(const double half_width, const double half_height, const PhysicsTransform pose)
{
...
PhysicsBody* PhysicsRendering::create_box_body(const double half_width, const double half_height, const PhysicsTransform pose)
{
